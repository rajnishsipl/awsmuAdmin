...
@Component("userMessageAggregation")
public class UserMessageAggregation {
	...
	public String toString() {
		return "UserMessageAggregation [_id=" + _id + ", chainId=" + chainId
				+ ", message=" + message + ", isRead=" + isRead
				+ ", deletedBy=" + deletedBy + ", createdDate=" + createdDate
				+ ", toUserId=" + toUserId + ", toUserUserName="
				+ toUserUserName + ", toUserDisplayName=" + toUserDisplayName
				+ ", toUserImage=" + toUserImage + ", toUserRole=" + toUserRole
				+ ", fromUserUserId=" + fromUserUserId + ", fromUserUserName="
				+ fromUserUserName + ", fromUserDisplayName="
				+ fromUserDisplayName + ", fromUserImage=" + fromUserImage
